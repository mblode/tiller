...
# [Tiller](https://blode.co/tiller)

**Learn to sail a dinghy in your browser: backwards tiller, invisible wind, no cold water**

Helm a pixel-art dinghy through seven lessons until you understand why a boat cannot sail straight into the wind.

</div>

## Demo

Runs in any browser, on a phone or a laptop. No wetsuit, no sailing club.
...
| Hike out, to lean and stay flat | Hold **HIKE** | `Shift` / `H` |
...
| 7 | The Full Course | The real windward and leeward race, with swimmers to rescue |
